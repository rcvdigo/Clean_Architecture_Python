...
from src.main.composers import user_update_composer
from src.main.composers import user_register_composer
...
from src.validators.user_update_validator import user_update_validator
...
@user_route_bp.route("/user/update", methods=["POST"])
def update_user():
    http_response = None
    try:
        # Protegendo a inserção de dados injetando o validator user_update_validator
        user_update_validator(request=request_flask)
